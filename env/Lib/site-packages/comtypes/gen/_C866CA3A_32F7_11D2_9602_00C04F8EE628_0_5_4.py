...
__all__ = [
    'SAFTGSM610_22kHzMono', 'SVP_3', 'eLEXTYPE_PRIVATE15',
    'DISPID_SRCBookmark', 'DISPID_SASCurrentSeekPosition',
    'SPGRAMMARSTATE', 'DISPID_SMSADeviceId', 'ISpPhraseAlt',
    'SPINTERFERENCE_NOISE', 'DISPID_SVGetProfiles', 'SPSUnknown',
    'SPAO_NONE', 'SPEI_RECO_OTHER_CONTEXT',
    'SAFTCCITT_uLaw_44kHzMono', 'ISpeechPhraseInfoBuilder',
    'SPSSuppressWord', 'SpeechGrammarTagUnlimitedDictation',
    'SPEI_RESERVED5', 'SAFT11kHz16BitMono',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SAFT11kHz16BitStereo', 'SAFT44kHz8BitStereo', 'SP_VISEME_17',
    'STCInprocHandler', 'SSTTWildcard', 'ISpEventSink',
    'SPADAPTATIONRELEVANCE', 'SAFTGSM610_8kHzMono',
    'SAFTExtendedAudioFormat', 'SPEI_SR_AUDIO_LEVEL',
    'SpeechVoicePriority', 'ISpeechLexiconWord', 'SVP_15',
    'DISPID_SRGDictationUnload', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'eLEXTYPE_PRIVATE5', 'SAFTGSM610_44kHzMono', 'SPWORDLIST',
    'SpeechCategoryPhoneConverters', 'STCLocalServer',
    'DISPID_SPPChildren', 'ISpeechCustomStream',
    'SDA_No_Trailing_Space', 'DISPIDSPRG',
    'DISPID_SRGDictationSetState', 'ISpeechPhraseProperty',
    'SVEVoiceChange', 'DISPID_SLPSymbolic', 'SPEI_HYPOTHESIS',
    'SPEI_START_SR_STREAM', 'SAFTADPCM_11kHzStereo', 'SP_VISEME_15',
    'DISPID_SPRuleParent', 'SAFTCCITT_ALaw_11kHzStereo', 'SVP_19',
    'SVP_5', 'DISPID_SFSOpen', 'DISPID_SMSALineId', 'SPLO_STATIC',
    'SAFTADPCM_44kHzStereo', 'ISpeechDataKey', 'ISpResourceManager',
    'DISPID_SVGetVoices', 'SPBINARYGRAMMAR', 'SPVPRI_ALERT',
    'SP_VISEME_2', 'SpeechDisplayAttributes',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SPIElements',
    'SRCS_Enabled', 'DISPID_SPAs_NewEnum',
    'DISPID_SpeechPhraseElement', 'DISPID_SRGSetTextSelection',
    'WAVEFORMATEX', 'ISpRecognizer', 'SPRS_INACTIVE',
    'DISPID_SpeechRecognizer', 'SRAImport', 'DISPID_SADefaultFormat',
    'SAFT24kHz16BitMono', 'SRERequestUI', 'SGDSActive', 'SITooLoud',
    'DISPID_SRCERecognition', 'DISPID_SpeechGrammarRule',
    'SPINTERFERENCE_NOSIGNAL', 'eLEXTYPE_PRIVATE3',
    'DISPID_SOTIsUISupported', 'DISPID_SVEEnginePrivate',
    'DISPID_SASNonBlockingIO', 'SPSNoun', 'SPPS_Modifier',
    'DISPID_SRCPause', 'SpeechGrammarRuleStateTransitionType',
    'SAFT12kHz8BitMono', 'DISPID_SPRDisplayAttributes',
    'DISPID_SVGetAudioOutputs', 'eWORDTYPE_DELETED', 'SVEViseme',
    'ISpeechLexicon', 'ISpShortcut',
    'DISPID_SLAddPronunciationByPhoneIds',
    'ISpeechTextSelectionInformation', 'ISpeechLexiconPronunciations',
    'SRTAutopause', 'DISPID_SVDisplayUI', 'DISPID_SGRSTNextState',
    'DISPID_SVSInputWordPosition', 'DISPID_SRCEHypothesis',
    'DISPID_SPAsCount', 'SPAR_Unknown', 'SPVPRIORITY',
    'SpeechMicTraining', 'ISpeechAudioStatus', 'DISPID_SRCVoice',
    'SRERecognition', 'DISPID_SPELexicalForm', 'SAFT16kHz16BitMono',
    'DISPID_SPPsCount', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SOTMatchesAttributes', 'SVSFDefault',
    'ISpeechRecoContext', 'SPAS_PAUSE', 'SAFT11kHz8BitStereo',
    'SpStreamFormatConverter', 'DISPID_SpeechPhraseProperties',
    'SpeechTokenIdUserLexicon', 'DISPID_SVGetAudioInputs',
    'DISPID_SPEAudioSizeTime', 'SAFT22kHz16BitStereo',
    'SAFTCCITT_ALaw_11kHzMono', 'SPWT_LEXICAL', 'SWTDeleted',
    'SPEI_SOUND_END', 'SAFTNonStandardFormat',
    'DISPID_SRRTOffsetFromStart', 'SAFTCCITT_uLaw_11kHzMono',
    'SP_VISEME_14', 'DISPID_SRSetPropertyString', 'DISPID_SPPName',
    'SPINTERFERENCE_NONE', 'DISPID_SPIProperties',
    'SSSPTRelativeToCurrentPosition', 'Speech_StreamPos_Asap',
    'SPSEMANTICFORMAT', '_ISpeechRecoContextEvents',
    'SpeechSpecialTransitionType', 'SpSharedRecoContext',
    'SPLEXICONTYPE', 'SVSFParseSapi', 'SpeechDataKeyLocation',
    'SP_VISEME_6', 'SpeechRecoContextState', 'SpeechVoiceSpeakFlags',
    'SDTPronunciation', 'SPXMLRESULTOPTIONS', 'DISPID_SAFGuid',
    'DISPID_SLWType', 'SDKLCurrentConfig', 'SVP_14', 'SP_VISEME_13',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SLPs_NewEnum',
    'DISPID_SRRRecoContext', 'SpeechStreamSeekPositionType',
    'SDTLexicalForm', 'SpeechCategoryAudioIn', 'ISpRecoGrammar2',
    'eLEXTYPE_APP', 'SPSLMA', 'SAFT8kHz16BitStereo',
    'DISPID_SRCEAdaptation', 'SPEI_SR_PRIVATE', 'DISPID_SOTCSetId',
    'DISPID_SRCCreateGrammar', 'SpeechPropertyResourceUsage',
    'SPCT_SUB_DICTATION', 'SSFMCreateForWrite', 'SRAInterpreter',
    'SPPS_RESERVED4', 'DISPID_SRGCmdLoadFromResource',
    'SPGRAMMARWORDTYPE', 'SSFMOpenReadWrite',
    'eLEXTYPE_VENDORLEXICON', 'eLEXTYPE_PRIVATE4',
    'DISPID_SABufferNotifySize', 'IInternetSecurityMgrSite',
    'DISPID_SRCState', 'SPXRO_Alternates_SML', 'DISPID_SABIEventBias',
    'DISPID_SVVolume', 'DISPID_SPRuleChildren', 'SPBO_NONE',
    'ISpNotifyTranslator', 'DISPID_SVSpeakCompleteEvent', 'SPAS_STOP',
    'ISpeechRecognizer', 'DISPID_SPPBRestorePhraseFromMemory',
    'SPEVENT', 'DISPID_SAFGetWaveFormatEx', 'SPVPRI_OVER',
    'SP_VISEME_19', 'SpeechPropertyComplexResponseSpeed',
    'SP_VISEME_1', 'DISPID_SRGState', 'DISPID_SpeechRecoResult',
    'SAFT22kHz16BitMono', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SRCEFalseRecognition', 'DISPID_SpeechGrammarRules',
    'SpeechPropertyLowConfidenceThreshold', 'Speech_Default_Weight',
    'SPPHRASEPROPERTY', 'UINT_PTR', 'DISPID_SpeechGrammarRuleState',
    'SpeechAudioFormatGUIDText', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SBSSeek', 'ISpeechBaseStream', 'ISpNotifySink',
    'ISpeechPhraseAlternate', 'DISPID_SRSNumberOfActiveRules',
    'SPPHRASE', 'SpMMAudioOut', 'SPGS_EXCLUSIVE',
    'ISpeechPhraseElements', 'SGRSTTEpsilon', 'SRSInactiveWithPurge',
    'DISPID_SRStatus', 'SINoise', 'DISPID_SRAudioInput',
    'SRATopLevel', 'IEnumString', 'DISPID_SPRules_NewEnum', 'SRARoot',
    'DISPID_SRSClsidEngine', 'SPWF_SRENGINE', 'DISPID_SMSAMMHandle',
    'SpeechPartOfSpeech', 'DISPID_SPIAudioStreamPosition',
    'SSSPTRelativeToEnd', 'DISPID_SPRsCount',
    'DISPID_SRGetRecognizers', 'DISPID_SVAudioOutputStream',
    'ISpeechVoiceStatus', 'STSF_LocalAppData',
    'SPINTERFERENCE_TOOFAST', 'SPEI_START_INPUT_STREAM',
    'DISPID_SRGDictationLoad', 'SAFT24kHz16BitStereo',
    'DISPID_SLPType', 'SpeechDiscardType',
    'DISPID_SRSSupportedLanguages', 'SpMMAudioIn',
    'eLEXTYPE_PRIVATE16', 'DISPID_SGRSTsItem',
    'DISPID_SPEAudioTimeOffset', 'SITooSlow', 'DISPID_SRRSpeakAudio',
    'SPSHORTCUTPAIRLIST', 'DISPID_SPIRule', 'SPSEMANTICERRORINFO',
    'SPEI_SOUND_START', 'SPEI_ADAPTATION', 'SVP_1',
    'eLEXTYPE_RESERVED4', 'DISPID_SPRuleNumberOfElements',
    'ISpeechRecognizerStatus', 'SSTTDictation', 'DISPID_SOTsItem',
    'SpeechVisemeFeature', 'SPEVENTENUM', 'SpeechEngineConfidence',
    'DISPID_SWFEChannels', 'SpObjectToken', 'eLEXTYPE_PRIVATE2',
    'SP_VISEME_9', 'SPEI_RESERVED2', 'ISpeechAudio',
    'DISPID_SPPs_NewEnum', 'SAFTNoAssignedFormat', 'SPGS_DISABLED',
    'ISpRecoContext2', 'SVF_Emphasis', 'DISPID_SpeechPhraseInfo',
    'SpMemoryStream', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SPPsItem', 'SpFileStream', 'SPCS_DISABLED', 'SPFILEMODE',
    'DISPID_SDKSetBinaryValue', 'SVEAudioLevel', 'SRAONone',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SpeechAudioFormatType',
    'SPPHRASERULE', 'DISPID_SpeechLexicon', 'SPEI_RESERVED6',
    'DISPID_SRCESoundStart', 'DISPID_SGRSTRule', 'SECFIgnoreWidth',
    'tagSPPROPERTYINFO', 'IInternetSecurityManager', 'SPPS_Unknown',
    'SRSEIsSpeaking', 'SPWT_DISPLAY', 'DISPID_SVSpeakStream',
    'SPPROPERTYINFO', 'SVEWordBoundary', 'DISPID_SDKSetLongValue',
    'SPRST_NUM_STATES', 'ISpeechPhraseReplacements',
    'SPSERIALIZEDPHRASE', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SCSBaseStream', 'eWORDTYPE_ADDED', 'SPSNotOverriden',
    'DISPID_SPARecoResult', 'SPPS_RESERVED1', 'DISPID_SPEs_NewEnum',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SDKGetStringValue',
    'SVESentenceBoundary', 'SDTAudio', 'DISPID_SPRuleName',
    'DISPID_SWFEBitsPerSample', 'SAFT22kHz8BitMono', 'SPSModifier',
    'ISpStreamFormat', 'SVSFUnusedFlags', 'ISpeechRecoGrammar',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SRCCmdMaxAlternates',
    'SPAS_RUN', 'SRTStandard', 'ISpeechPhraseRules',
    'DISPID_SpeechPhraseRule', 'SASRun', 'SPBO_AHEAD', 'SP_VISEME_18',
    'SDA_Two_Trailing_Spaces', 'SPDKL_DefaultLocation',
    'DISPID_SRCRetainedAudioFormat', 'SPWORDPRONUNCIATION',
    'DISPID_SOTGetStorageFileName', 'DISPID_SLGetWords',
    'SPEVENTSOURCEINFO', 'SpeechTokenKeyUI', 'SpeechRegistryUserRoot',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SRRSetTextFeedback',
    'SGPronounciation', 'eLEXTYPE_PRIVATE19',
    'SpeechVoiceSkipTypeSentence', 'SREAllEvents',
    'DISPID_SDKDeleteValue', 'SPWORDPRONOUNCEABLE', 'DISPID_SPAsItem',
    'DISPID_SPRuleEngineConfidence', 'SECFIgnoreKanaType',
    'SpeechAllElements', 'DISPID_SGRSTPropertyName',
    'DISPID_SPIEnginePrivateData', 'STSF_AppData',
    'DISPID_SRCEPhraseStart', 'ISpeechObjectTokens',
    'DISPID_SpeechAudioFormat', 'SAFTCCITT_ALaw_44kHzMono',
    'SPEI_VOICE_CHANGE', 'eLEXTYPE_RESERVED9', 'DISPID_SGRSTText',
    ...
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SVSInputWordLength',
    'SPAUDIOBUFFERINFO', 'DISPID_SLPLangId', 'SPPS_RESERVED2',
    'SPCT_DICTATION', 'SpCompressedLexicon', 'SpWaveFormatEx',
    'SPEI_MIN_TTS', 'SPFM_CREATE', 'SP_VISEME_12', 'SVP_7',
    'DISPID_SVWaitUntilDone', 'STCRemoteServer',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SLGenerationId',
    'SPRECOGNIZERSTATUS', 'SpeechVisemeType', 'DISPID_SVStatus',
    'DISPID_SRRTimes', 'SAFT48kHz16BitMono', 'DISPID_SVRate',
    'SPSFunction', 'SpPhoneConverter', 'DISPID_SPRuleConfidence',
    'SVP_21', 'SVP_13', 'SPFM_OPEN_READONLY',
    'DISPID_SpeechRecoContext', 'DISPID_SRGCmdLoadFromFile',
    'SSFMOpenForRead', 'SBOPause', 'SVSFIsXML',
    'DISPID_SOTRemoveStorageFileName', 'SVEPhoneme', 'SPSHT_Unknown',
    'ISpeechRecoResultDispatch', 'SGRSTTTextBuffer',
    'SAFTGSM610_11kHzMono', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SDKEnumValues', 'SRESoundEnd',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SVVoice',
    'SPSHT_NotOverriden', 'DISPID_SASState', 'SVF_Stressed',
    'DISPID_SVSLastStreamNumberQueued', 'SRERecoOtherContext',
    'DISPID_SVSpeak', 'SAFT22kHz8BitStereo',
    'DISPID_SPIAudioSizeBytes', 'SPSHORTCUTTYPE', 'SpeechFormatType',
    'SAFT12kHz16BitMono', 'SPRECOCONTEXTSTATUS', 'SGRSTTWildcard',
    'DISPID_SVPause', 'SPEI_INTERFERENCE', 'SAFT11kHz8BitMono',
    'DISPID_SGRInitialState', 'SREAdaptation',
    'DISPID_SREmulateRecognition', 'SVEEndInputStream',
    'DISPID_SPAStartElementInResult', 'DISPID_SAEventHandle',
    'DISPID_SPPNumberOfElements', 'SDTAlternates',
    'SREFalseRecognition', 'SPEI_REQUEST_UI', 'SVP_12',
    'SAFTADPCM_8kHzMono', 'SPRST_ACTIVE',
    'DISPID_SpeechGrammarRuleStateTransition', 'STCInprocServer',
    'DISPID_SRAudioInputStream', 'DISPID_SRRAlternates',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SVEBookmark', 'STCAll',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SPRs_NewEnum', 'SAFT8kHz8BitStereo',
    'DISPID_SLPPartOfSpeech', 'DISPID_SRCEEnginePrivate',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPEI_RESERVED3',
    'SDKLDefaultLocation', 'DISPID_SRGetPropertyNumber',
    'SREStreamStart', 'DISPID_SPPId', 'SPSHT_OTHER',
    'DISPID_SpeechMemoryStream', '_RemotableHandle',
    'SPINTERFERENCE_TOOSLOW', 'SREPropertyNumChange',
    'DISPID_SVEVoiceChange', 'DISPID_SGRAddState', 'DISPID_SGRClear',
    'DISPID_SVEStreamEnd', 'SRSEDone', 'SVPOver',
    '__MIDL_IWinTypes_0009', 'SVSFPersistXML', 'DISPID_SpeechDataKey',
    'DISPID_SpeechCustomStream', 'SWPUnknownWordPronounceable',
    'SGLexicalNoSpecialChars', 'SDA_Consume_Leading_Spaces',
    'SPSHT_EMAIL', 'DISPID_SPIReplacements', 'SDA_One_Trailing_Space',
    'SAFT44kHz16BitMono', 'DISPID_SWFEAvgBytesPerSec',
    'Speech_StreamPos_RealTime', 'eLEXTYPE_RESERVED8', 'SP_VISEME_7',
    'SPEI_RESERVED1', 'DISPID_SRIsUISupported', 'SpeechAudioVolume',
    'DISPID_SRCRequestedUIType',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SpeechLexiconWord', 'SPINTERFERENCE_TOOLOUD',
    'SpObjectTokenCategory', 'DISPID_SpeechPhraseRules',
    'DISPID_SGRSTWeight', 'DISPID_SWFESamplesPerSec',
    'DISPID_SAFType', 'ISpeechGrammarRules',
    'SWPUnknownWordUnpronounceable', 'eLEXTYPE_USER_SHORTCUT',
    'SpeechAddRemoveWord', 'DISPID_SPANumberOfElementsInResult',
    'SpeechVoiceEvents', 'SPEI_TTS_BOOKMARK',
    'DISPID_SGRSTransitions', 'DISPID_SVAudioOutput',
    'SAFT24kHz8BitMono', 'SDKLLocalMachine', 'DISPID_SPCLangId',
    'ISpObjectTokenCategory', 'ISpeechAudioFormat', 'ISpRecoContext',
    'DISPID_SRCEEndStream', 'DISPID_SBSFormat',
    'DISPID_SRCERecognitionForOtherContext', 'SAFT12kHz16BitStereo',
    'SPAUDIOOPTIONS', 'SpeechCategoryRecoProfiles',
    'DISPID_SOTRemove', 'SAFTCCITT_uLaw_8kHzMono',
    'SPEI_END_INPUT_STREAM', 'SPWORDPRONUNCIATIONLIST',
    'SPINTERFERENCE', 'SGDSActiveUserDelimited',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SRCreateRecoContext',
    'SPSVerb', 'SPFM_NUM_MODES', 'SPBO_TIME_UNITS',
    'SPPHRASEREPLACEMENT', 'DISPID_SWFEBlockAlign',
    'DISPID_SPERetainedSizeBytes', 'SFTSREngine',
    'SAFTADPCM_44kHzMono', 'ISpVoice', 'DISPID_SVSLastResult',
    'SPLOADOPTIONS', 'ISpeechGrammarRuleState',
    'DISPID_SRGetPropertyString', 'SAFTDefault', 'SVP_10',
    'SPEI_FALSE_RECOGNITION', 'SpeechRecoEvents',
    'SpeechPropertyNormalConfidenceThreshold',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SpLexicon', 'SAFTADPCM_22kHzMono',
    'ISpPhoneConverter', 'SGSEnabled', 'DISPID_SGRAddResource',
    'SP_VISEME_8', 'DISPID_SOTCEnumerateTokens',
    'SpPhoneticAlphabetConverter', 'DISPID_SVSRunningState',
    'SPEI_UNDEFINED', 'SVP_11', 'DISPID_SVSkip', 'DISPID_SOTsCount',
    'DISPID_SASetState', 'SPWORD', 'SPSMF_UPS', 'ISpeechRecoResult',
    'SPCS_ENABLED', 'DISPID_SPIGrammarId', 'SPRULESTATE',
    'SVSFParseAutodetect', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'ISpMMSysAudio', 'SPPS_NotOverriden', 'SP_VISEME_10',
    'SpInprocRecognizer', 'ISpPhoneticAlphabetConverter',
    'DISPID_SRCCreateResultFromMemory', 'SP_VISEME_0',
    'SpeechInterference', 'DISPID_SPIRetainedSizeBytes',
    'SpAudioFormat', 'DISPID_SVSyncronousSpeakTimeout',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SpeechRecoResult2', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SPEsCount',
    'SpVoice', 'SAFT16kHz8BitStereo', 'DISPID_SpeechObjectTokens',
    'DISPID_SPIEngineId', 'DISPID_SGRSTPropertyValue',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SPEEngineConfidence', 'SGRSTTWord',
    'SpeechLexiconType', 'DISPID_SDKDeleteKey', 'SRTEmulated',
    'SpeechTokenKeyAttributes', 'ISpeechAudioBufferInfo',
    'DISPID_SVEWord', 'SVSFIsNotXML', 'DISPID_SAVolume',
    'DISPID_SVESentenceBoundary', 'DISPID_SOTGetAttribute', 'SVP_17',
    'DISPID_SPIAudioSizeTime', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SRProfile', 'DISPID_SGRsAdd', 'SPTEXTSELECTIONINFO',
    'SVP_0', 'ISpDataKey', 'SPEI_MIN_SR', 'DISPID_SOTs_NewEnum',
    'DISPID_SABIMinNotification', 'DISPID_SPEActualConfidence',
    'DISPID_SGRsCommitAndSave', 'SpResourceManager',
    'eLEXTYPE_PRIVATE10', 'DISPID_SRRTTickCount', 'SPAO_RETAIN_AUDIO',
    'DISPID_SDKSetStringValue', 'DISPID_SVResume',
    'DISPID_SDKOpenKey', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SpeechAudio',
    'SAFTCCITT_uLaw_8kHzStereo', 'SAFTCCITT_uLaw_11kHzStereo',
    'SP_VISEME_5', 'SAFT24kHz8BitStereo', 'SpNotifyTranslator',
    'ISpSerializeState', 'DISPID_SRRSaveToMemory', 'DISPID_SBSWrite',
    'DISPID_SRGIsPronounceable', 'SpeechTokenKeyFiles', 'SINone',
    'DISPID_SRCEInterference', 'DISPID_SPRulesItem',
    'DISPID_SGRs_NewEnum', 'DISPID_SGRSAddWordTransition',
    'DISPID_SDKEnumKeys', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SVIsUISupported',
    'DISPID_SMSSetData', 'Speech_Max_Word_Length', 'SPSHORTCUTPAIR',
    'SPFM_CREATE_ALWAYS', 'SECFDefault', 'SpeechUserTraining',
    'DISPID_SOTDataKey', 'DISPID_SPIStartTime',
    'DISPID_SRSCurrentStreamNumber', 'SpeechCategoryAppLexicons',
    'DISPID_SpeechPhoneConverter', 'SpeechAudioFormatGUIDWave',
    'SAFT48kHz8BitStereo', 'DISPID_SRCEBookmark', 'DISPID_SPACommit',
    'SPRST_INACTIVE', 'DISPID_SOTId', 'SAFT32kHz8BitMono', 'SFTInput',
    'SGDisplay', 'eLEXTYPE_RESERVED6', 'DISPID_SOTCGetDataKey',
    'DISPID_SpeechLexiconProns', 'SpCustomStream',
    'SAFTADPCM_8kHzStereo', 'SPRECORESULTTIMES',
    'DISPID_SpeechPhraseAlternate', 'SITooFast',
    'SpeechEngineProperties', 'SP_VISEME_3', 'SVP_9',
    'ISpeechGrammarRuleStateTransition',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SRGReset',
    'SPWAVEFORMATTYPE', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SRSetPropertyNumber', 'SECFEmulateResult',
    'SREHypothesis', 'SAFT12kHz8BitStereo', 'DISPID_SOTCId',
    'SRTReSent', 'DISPID_SGRsItem', 'SPPHRASEELEMENT',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SPAPhraseInfo',
    '_SPAUDIOSTATE', 'SRADynamic', 'DISPID_SBSRead', 'SSTTTextBuffer',
    'DISPID_SASFreeBufferSpace', 'DISPID_SVEViseme', 'SLTApp',
    'eLEXTYPE_USER', 'DISPID_SLWWord', 'DISPID_SPILanguageId',
    'SP_VISEME_20', 'DISPID_SDKCreateKey', 'SLODynamic',
    'DISPID_SRGCommit', 'SAFT8kHz16BitMono', 'LONG_PTR',
    'SDKLCurrentUser', 'DISPID_SRRPhraseInfo', 'DISPID_SVSVisemeId',
    'DISPID_SPERequiredConfidence', 'DISPID_SLRemovePronunciation',
    'SPGS_ENABLED', 'SPEI_RECOGNITION', 'SPEI_SR_BOOKMARK',
    'SECNormalConfidence', 'DISPID_SRCEStartStream',
    'SpInProcRecoContext', 'DISPID_SGRName', 'DISPID_SPRuleId',
    'SVEBookmark', 'SPWF_INPUT', 'SAFT44kHz8BitMono',
    'SPWT_PRONUNCIATION',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SAFT32kHz16BitStereo', 'DISPID_SPRNumberOfElements', 'SASClosed',
    'DISPID_SVEStreamStart', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SRADefaultToActive', 'SPEI_MAX_SR', 'DISPID_SRRAudio',
    'eLEXTYPE_RESERVED7', 'DISPID_SVEPhoneme', 'SVSFNLPMask',
    'SPCONTEXTSTATE', 'DISPID_SVEAudioLevel',
    'DISPID_SpeechObjectToken', 'DISPID_SPISaveToMemory',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SGRSTType',
    'SPRST_INACTIVE_WITH_PURGE', 'ISpObjectWithToken',
    'SpNullPhoneConverter', 'SPPS_Noun', 'SPVPRI_NORMAL',
    'eLEXTYPE_PRIVATE1', 'DISPID_SpeechRecognizerStatus',
    'SINoSignal', 'DISPID_SOTCreateInstance', 'SREInterference',
    'ISpeechFileStream', 'SAFT16kHz16BitStereo',
    'SpeechDictationTopicSpelling', 'eLEXTYPE_PRIVATE18',
    'SVSFlagsAsync', 'SRCS_Disabled', 'SRESoundStart',
    'SPDKL_LocalMachine', 'DISPID_SPRulesCount', 'DISPID_SLPPhoneIds',
    'SPEI_SR_RETAINEDAUDIO', 'ISpeechMemoryStream',
    'DISPID_SRRGetXMLResult', 'ISpXMLRecoResult',
    'eLEXTYPE_PRIVATE11', 'SRSActiveAlways',
    'DISPID_SpeechAudioStatus', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SGDSInactive', 'SPBOOKMARKOPTIONS', 'SRTSMLTimeout',
    'SECFNoSpecialChars', 'SGDSActiveWithAutoPause',
    'SpeechGrammarTagWildcard', 'SVP_20', 'SpeechRuleState',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SITooQuiet',
    'DISPID_SGRSTPropertyId', 'SpeechGrammarState',
    'DISPID_SRGCmdSetRuleIdState', 'SP_VISEME_4',
    'DISPID_SPEDisplayText', 'ISpPhrase', 'SP_VISEME_16',
    'eLEXTYPE_PRIVATE7', 'DISPID_SGRsCommit', 'SAFT8kHz8BitMono',
    'DISPID_SABIBufferSize', 'SPAUDIOSTATE', 'eLEXTYPE_RESERVED10',
    'DISPID_SRGRecoContext', 'DISPID_SGRsDynamic',
    'eLEXTYPE_PRIVATE8', 'DISPID_SVEventInterests', 'SP_VISEME_21',
    'DISPID_SRDisplayUI', 'ISpeechPhraseAlternates',
    'ISpeechPhraseProperties', 'ISpRecognizer3',
    'SpUnCompressedLexicon', 'SRSActive', 'DISPID_SpeechVoiceStatus',
    'SDTAll', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SpeechVoiceEvent', 'DISPID_SPPConfidence', 'SPBO_PAUSE',
    'SPCT_SUB_COMMAND', 'DISPID_SpeechVoice', 'SAFT32kHz16BitMono',
    'eLEXTYPE_PRIVATE6', 'DISPID_SpeechObjectTokenCategory',
    'SPSERIALIZEDRESULT', 'ISpeechPhoneConverter',
    'SWPKnownWordPronounceable', 'SpeechEmulationCompareFlags',
    'SPPS_Noncontent', 'SGRSTTDictation', 'SPEI_MAX_TTS',
    'DISPID_SGRAttributes', 'DISPID_SVSInputSentencePosition',
    'ISpeechPhraseInfo', 'SLTUser', 'SRSInactive',
    'DISPID_SPCIdToPhone', 'SPAR_High', 'SPCT_SLEEP',
    'DISPID_SLWsItem', 'eLEXTYPE_PRIVATE9', 'SREPropertyStringChange',
    'SpeechCategoryRecognizers', 'DISPID_SRSCurrentStreamPosition',
    'SPCATEGORYTYPE', 'SPEI_SENTENCE_BOUNDARY', 'SVP_8',
    'SPPS_SuppressWord', 'ISpEventSource', 'DISPID_SOTSetId',
    'DISPID_SLWsCount', 'SREStreamEnd', 'ISpRecoCategory',
    'SREBookmark', 'DISPID_SPRsItem', 'DISPID_SGRId',
    'DISPID_SPIGetText', 'DISPID_SRCRetainedAudio', 'SVSFIsFilename',
    'SpeechRecoProfileProperties', 'DISPID_SRCResume', 'SVPAlert',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SVSLastBookmark',
    'SPFM_OPEN_READWRITE', 'STSF_CommonAppData',
    'SAFT48kHz16BitStereo', 'SPVOICESTATUS', 'SVP_4',
    'SpeechTokenShellFolder', 'SPRST_ACTIVE_ALWAYS', 'ISpeechVoice',
    'ISpStream', 'SPEI_PHRASE_START', 'SpSharedRecognizer',
    'SpeechWordPronounceable', 'SPRULE', 'SPAS_CLOSED',
    'SECFIgnoreCase', 'ISpeechPhraseRule', 'DISPID_SPCPhoneToId',
    'DISPID_SRCRecognizer', 'ISpeechMMSysAudio', 'DISPID_SRRTLength',
    'DISPID_SPPValue', 'SRTExtendableParse',
    'SpeechGrammarTagDictation', 'DISPID_SDKGetlongValue',
    'DISPID_SABufferInfo', 'SECLowConfidence',
    'DISPID_SPEDisplayAttributes', 'DISPID_SRCERequestUI',
    'SpMMAudioEnum', 'ISpeechXMLRecoResult', 'SVEPrivate',
    'SpeechBookmarkOptions', 'Speech_Max_Pron_Length',
    'SAFT16kHz8BitMono', 'SPDKL_CurrentConfig',
    'ISpeechResourceLoader', 'SVSFParseSsml',
    'DISPID_SRCSetAdaptationData', 'DISPID_SLPsCount', 'SpShortcut',
    ...
    'SAFTCCITT_ALaw_44kHzStereo', 'ISpeechObjectToken',
    'eLEXTYPE_PRIVATE20', 'SAFT44kHz16BitStereo',
    'SPEI_END_SR_STREAM', 'ISpeechLexiconWords',
    'ISpeechPhraseElement', 'SAFTADPCM_22kHzStereo',
    'ISpeechRecoResult2', 'SVSFPurgeBeforeSpeak',
    'DISPID_SVSPhonemeId', 'DISPID_SOTDisplayUI', 'ISpObjectToken',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SFSClose',
    'DISPID_SPRuleFirstElement', 'tagSPTEXTSELECTIONINFO',
    'SPEI_TTS_AUDIO_LEVEL', 'SGLexical', 'DISPID_SLAddPronunciation',
    'SAFTADPCM_11kHzMono', 'DISPID_SpeechLexiconPronunciation',
    'SPAR_Medium', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SDKGetBinaryValue', 'SPAR_Low', 'SPCT_COMMAND',
    'SPWORDTYPE', 'DISPID_SRSAudioStatus',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPRS_ACTIVE', 'SWTAdded',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', '_ISpeechVoiceEvents',
    'DISPID_SPEPronunciation', 'DISPID_SPEsItem', 'SpeechWordType',
    'SSFMCreate', 'DISPID_SVSInputSentenceLength',
    'DISPID_SGRSAddRuleTransition', 'SpStream',
    'DISPID_SpeechPhraseBuilder', 'ISpeechObjectTokenCategory',
    'DISPID_SRCESoundEnd', 'DISPID_SOTGetDescription',
    'DISPID_SGRSRule', 'SPEI_PHONEME', 'ISpRecoGrammar',
    'SPINTERFERENCE_TOOQUIET', 'SPPARTOFSPEECH', 'SPPS_Function',
    'SPAUDIOSTATUS', 'SPVISEMES', 'SPDATAKEYLOCATION',
    'ISpProperties', 'SDTProperty', 'SAFT48kHz8BitMono',
    'SpeechTokenValueCLSID', 'SGRSTTRule', 'DISPID_SMSGetData',
    'SpeechRecognizerState', 'SPRECOSTATE',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SLPsItem', 'SPEI_VISEME',
    'SpeechRunState', 'DISPID_SpeechFileStream',
    'SpeechCategoryVoices', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SRIsShared', 'DISPID_SRCAudioInInterferenceStatus',
    'tagSTATSTG', 'SPLO_DYNAMIC', 'STSF_FlagCreate',
    'DISPID_SpeechPhraseReplacements', 'SRAExport',
    'DISPID_SPPEngineConfidence', 'SPXRO_SML', 'DISPID_SLWLangId',
    'ISpPhoneticAlphabetSelection', 'SDTRule',
    'DISPID_SRCEAudioLevel', 'SAFTCCITT_uLaw_22kHzStereo',
    'SPSTREAMFORMATTYPE', 'DISPID_SRGSetWordSequenceData',
    'SGSDisabled', 'SPPS_RESERVED3', 'SPPS_LMA', 'SPEI_TTS_PRIVATE',
    'SVF_None', 'SVP_16', 'SVP_18', 'DISPID_SpeechBaseStream',
    'ISpeechWaveFormatEx', 'SREStateChange', 'SLOStatic',
    'DISPID_SRRAudioFormat', 'DISPID_SRCEPropertyNumberChange',
    'eLEXTYPE_PRIVATE17', 'SVPNormal', 'IStream', 'SPSInterjection',
    'SpeechStreamFileMode', 'SASStop', 'SpPhraseInfoBuilder',
    'eLEXTYPE_PRIVATE12', 'SVSFVoiceMask', 'ISpRecoResult',
    'DISPID_SLWs_NewEnum', 'SSSPTRelativeToStart',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SPPFirstElement',
    'DISPID_SRRTStreamTime', 'DISPID_SGRSTsCount', 'SRAORetainAudio',
    'SVEAllEvents', 'DISPID_SPEAudioStreamOffset', 'ISpNotifySource',
    'ISpAudio', 'DISPID_SpeechLexiconWords', 'SREPrivate',
    'ISpeechGrammarRule', 'DISPID_SpeechMMSysAudio',
    'DISPID_SOTCategory', 'DISPID_SPRFirstElement',
    'SPPS_Interjection', 'SpeechLoadOption',
    'ISpeechPhraseReplacement', 'SpeechPropertyResponseSpeed',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SLWPronunciations',
    'DISPIDSPTSI', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SRGetFormat', 'DISPID_SPPParent', 'SVSFNLPSpeakPunc',
    'SpeechRecognitionType', 'DISPID_SpeechPhraseProperty',
    'SVEStartInputStream', 'SREAudioLevel', 'ISequentialStream',
    'SPRS_ACTIVE_USER_DELIMITED', 'SP_VISEME_11', 'ISpLexicon',
    'ISpStreamFormatConverter', 'SDTReplacement',
    'ISpeechRecoResultTimes', 'SpeechAudioState', 'SPPS_Verb',
    'SPEI_PROPERTY_NUM_CHANGE', 'SAFTText', 'DISPID_SRState',
    'DISPID_SOTCDefault', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SVSLastBookmarkId', 'SGSExclusive',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SWFEExtraData',
    'SpeechRetainedAudioOptions', 'DISPID_SGRsFindRule',
    'SECHighConfidence', 'DISPID_SLGetPronunciations', 'SVP_6',
    'SDTDisplayText', 'DISPID_SGRsCount', 'SpeechRuleAttributes',
    'SAFT32kHz8BitStereo', 'ISpRecognizer2', 'eLEXTYPE_PRIVATE13',
    'SVP_2', 'SpeechTokenContext', 'DISPIDSPTSI_ActiveOffset',
    'ISpGrammarBuilder', 'SBONone', 'DISPID_SAStatus',
    'DISPID_SVPriority', 'DISPID_SPRText', 'SpeechCategoryAudioOut',
    'DISPID_SLGetGenerationChange', 'SpeechAudioProperties',
    'DISPID_SVAlertBoundary', 'SVSFParseMask', 'DISPID_SWFEFormatTag',
    'SpTextSelectionInformation', 'SpeechPropertyAdaptationOn',
    'DISPID_SRGId', 'SAFTCCITT_uLaw_22kHzMono',
    'SpeechGrammarWordType', 'SPEI_WORD_BOUNDARY',
    'SPEI_RECO_STATE_CHANGE', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SRRecognizer', 'IEnumSpObjectTokens', 'SASPause'
]

_check_version('1.1.14', 1619378694.603962)
